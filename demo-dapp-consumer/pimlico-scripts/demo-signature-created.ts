...
const endpointUrlForSigning =
  "https://eth-sepolia.g.alchemy.com/v2/JNhNDPi6eUjeYsNr8HeBXjeB93s0s1aa";
const bundlerClient = createClient({
  transport: http(endpointUrlForSigning),
  chain: sepolia,
})
...
const gasPrice = { maxFeePerGas: "0x18412", maxPriorityFeePerGas: "0x18412" }; //@notice hardcoded due to RPC unavailability pimlico await bundlerClient.getUserOperationGasPrice();
